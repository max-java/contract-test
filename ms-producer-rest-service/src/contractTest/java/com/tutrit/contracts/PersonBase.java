...
/**
 * The name for this class is depends on location of contracts/../*.groovy contracts and value of
 * i.e., contract is set in contracts/person/find_person_by_id.groovy, what will be evaluated to
 * PersonBase (by name of /person/ folder), and package where it should be located is sets by
 * packageWithBaseClasses = "com.tutrit.contracts" value. That gives
